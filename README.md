...
2. GitHub Action `Analyze herbarium review images` се пуска **само ръчно** (workflow_dispatch, харчи Gemini кредити): изпраща неанализираните файлове към Gemini чрез тайния ключ `GEMINI_API_KEY` и записва чернова в `data/review-results.json`.
